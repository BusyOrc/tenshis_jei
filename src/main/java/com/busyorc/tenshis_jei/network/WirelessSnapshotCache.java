...
public final class WirelessSnapshotCache {
    ...
    private static volatile List<SnapshotDataPacket.Entry> entries = List.of();
    private static volatile long lastUpdated = 0L;

    public static void update(List<SnapshotDataPacket.Entry> newEntries) {
        entries = List.copyOf(newEntries);
        lastUpdated = System.currentTimeMillis();
    }

    public static List<SnapshotDataPacket.Entry> getEntries() {
        return entries;
    }
